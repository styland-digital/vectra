...
1. **TOUJOURS** filtrer par `organization_id` dans les queries
...
1. **Ne pas** créer de routes sans vérifier l'organization_id
2. **Ne pas** appeler les APIs externes sans rate limiting
3. **Ne pas** modifier les prompts sans documenter
4. **Ne pas** merger sans tests passants
5. **Ne pas** utiliser de `print()`, utiliser `logger`
