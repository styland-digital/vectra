...
# Routes Billing (under /user/billing)
api_router.include_router(billing.router, prefix="/user/billing", tags=["billing"])

# Routes Analytics (under /user/analytics and /admin/analytics)
